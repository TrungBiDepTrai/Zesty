...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="container-fluid py-4">
            ...
            <div>
                <button type="button" class="btn btn-outline-primary" onclick="location.href='admin_add_blog.php';">Tạo mới</button>
            </div>
            <div class="card">
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Mã Admin</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Mã thành viên</th>
                            ...
                            <?php
                                ...
                                if ($result) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr>";
                                        echo "<td>" . $row['MaBlog'] . "</td>";
                                        echo "<td>" . $row['Title'] . "</td>";
                                        echo "<td>" . $row['NoiDung'] . "</td>";
                                        echo "<td>" . $row['MaAdmin'] . "</td>";
                                        echo "<td>" . $row['MaThanhVien'] . "</td>";
                                        echo "<td><a href='admin_edit_users.php?id=" . $row['MaBlog'] . "'>Sửa</a> | <a href='admin_delete_user.php?id=" . $row['MaBlog'] . "'>Xóa</a></td>";
                                        echo "</tr>";
                                    }
