...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="container-fluid py-4">
            ...
            <div>
                <button type="button" class="btn btn-outline-primary" onclick="location.href='admin_add_category.php';">Tạo mới</button>
            </div>
                            ...
                            <?php
                                ...
                                if ($result) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>" . $row['MoTa'] . "</td>";
                                        echo "<td><a href='admin_edit_category.php?id=" . $row['MaDanhMuc'] . "'>Sửa</a> | <a href='admin_delete_category.php?id=" . $row['MaDanhMuc'] . "'>Xóa</a></td>";
                                        echo "</tr>";
                                    }
